...
<header class="site-header">
  <div class="container header-inner">
    <a href="index.html" class="logo"><span class="logo-mark">E</span><span>Explorer<small>Taxi · Paris</small></span></a>
...
<footer class="site-footer">
  <div class="container">
    <div class="footer-grid">
      <div>
        <a href="index.html" class="logo"><span class="logo-mark">E</span><span>Explorer<small>Taxi · Paris</small></span></a>
        <p style="margin-top: 16px; max-width: 32ch; font-size: 14.5px;"><span data-lang="en">Wheelchair-accessible transfers in Paris and beyond. Run by Ahmad — driver, not a platform.</span><span data-lang="fr">Transferts accessibles à Paris et au-delà. Géré par Ahmad — un chauffeur, pas une plateforme.</span></p>
      </div>
      ...
      <div><h4><span data-lang="en">Company</span><span data-lang="fr">Société</span></h4><ul>
        <li><a href="about.html"><span data-lang="en">About Ahmad</span><span data-lang="fr">À propos</span></a></li>
      ...
      <div><h4><span data-lang="en">Reach Ahmad</span><span data-lang="fr">Joindre Ahmad</span></h4><ul>
        <li>📞 +33 6 12 34 56 78</li>
        <li>💬 WhatsApp 24/7</li>
        <li>✉️ hello@explorer-taxi.fr</li>
