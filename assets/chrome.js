  ...
  <div class="container">
    <div class="footer-grid">
      ...
      <div><h4><span data-lang="en">Reach us</span><span data-lang="fr">Nous contacter</span></h4><ul style="display:flex;flex-direction:column;gap:10px;">
        ...
        <li style="display:flex;align-items:flex-start;gap:8px;"><span style="font-size:16px;line-height:1.4;flex-shrink:0;">✉️</span><a href="mailto:contact@explorertaxiservice.com" style="color:inherit;font-weight:600;word-break:break-word;">contact@explorertaxiservice.com</a></li>
        <li style="color:rgba(247,244,238,0.85);font-size:13px;"><span data-lang="en">First reply within 2 hours</span><span data-lang="fr">Réponse sous 2h</span></li>
      </ul></div>
    </div>
